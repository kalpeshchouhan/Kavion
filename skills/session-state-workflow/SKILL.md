...
description: Use this skill to create, update, resume, inspect, or archive Kavion task session state in session.json, history.jsonl, plans, and reports.
---
...
9. Archive completed sessions into `.kavion/history.jsonl` instead of deleting them.
